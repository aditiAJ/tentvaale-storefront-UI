...
export const PRODUCTS: Product[] = [
  ...
  { id: "p16", name: "Majlis Lounge Package", category: "Furniture", subcategory: "Couches", rateType: "Qty", basePrice: 12000, imageUrl: U("photo-1781255575628-d645cc39160f"), size: "Lounge area 360 × 300 cm", colours: ["Multicolour"], materials: ["Cotton", "Wood"], moods: ["Boho", "Festive"], themes: ["Haldi & mehendi", "Boho"], setting: "Indoor & outdoor", fabrics: ["Cotton", "Silk", "Jute"], attributes: { "Seating capacity": "8", "Frame material": "Floor cushions" } },
  { id: "p60", name: "Sufi Mehfil Diwan Set", category: "Furniture", subcategory: "Couches", rateType: "Qty", basePrice: 9500, imageUrl: U("photo-1643785450216-2f4fb7d38fb6"), size: "Round diwan 300 cm Ø + 12 bolsters", colours: ["Maroon", "Gold"], materials: ["Wood", "Brocade"], moods: ["Regal", "Traditional"], themes: ["Royal heritage", "Boho"], setting: "Indoor & outdoor", fabrics: ["Velvet", "Silk", "Tissue"], attributes: { "Seating capacity": "10", "Frame material": "Low wooden platform" } },
  { id: "p68", name: "Haldi Yellow Baithak Seating", category: "Furniture", subcategory: "Couches", rateType: "Qty", basePrice: 4200, imageUrl: U("photo-1788346905967-f061fa707d36"), size: "240 × 90 × 45 cm", colours: ["Yellow", "Mustard"], materials: ["Wood", "Cotton"], moods: ["Festive", "Boho"], themes: ["Haldi & mehendi"], setting: "Indoor & outdoor", fabrics: ["Cotton", "Silk", "Jute"], attributes: { "Seating capacity": "4", "Frame material": "Low wooden platform" } },
  { id: "p1", name: "Regal Gold Bar Chair", category: "Furniture", subcategory: "Chairs", rateType: "Qty", basePrice: 450, imageUrl: U("photo-1583227061267-8428fb76fbfd"), size: "45 × 50 × 105 cm", colours: ["Gold"], materials: ["Metal"], moods: ["Glam"], themes: ["Modern luxe", "Corporate"], setting: "Indoor", fabrics: ["Velvet", "Leatherette"], attributes: { "Seating capacity": "1", "Frame material": "Metal" } },
  { id: "p26", name: "Ghost Acrylic Chair", category: "Furniture", subcategory: "Chairs", rateType: "Qty", basePrice: 300, imageUrl: U("photo-1744056996022-c33f1cc49030"), size: "54 × 56 × 92 cm", colours: ["Clear"], materials: ["Acrylic"], moods: ["Minimal"], themes: ["Modern luxe", "Corporate"], setting: "Indoor & outdoor", fabrics: [], attributes: { "Seating capacity": "1", "Frame material": "Acrylic" } },
  { id: "p69", name: "Rattan Peacock Chair", category: "Furniture", subcategory: "Chairs", rateType: "Qty", basePrice: 1600, imageUrl: U("photo-1560105860-9f9a2f98ea4e"), size: "95 × 70 × 150 cm", colours: ["Natural"], materials: ["Rattan"], moods: ["Boho", "Romantic"], themes: ["Boho", "Haldi & mehendi", "Beach"], setting: "Indoor & outdoor", fabrics: ["Cotton", "Linen"], attributes: { "Seating capacity": "1", "Frame material": "Rattan" } },
  { id: "p4", name: "Round Banquet Table (60in)", category: "Furniture", subcategory: "Tables and consoles", rateType: "Qty", basePrice: 350, imageUrl: U("photo-1751891159950-bf33e1e8705b"), size: "152 cm Ø × 76 cm", colours: ["White"], materials: ["MDF", "Steel"], moods: ["Classic"], themes: ["Corporate", "Floral garden"], setting: "Indoor & outdoor", fabrics: [], attributes: { "Seating capacity": "10", "Frame material": "Steel" } },
  { id: "p5", name: "Marble Cocktail Table", category: "Furniture", subcategory: "Tables and consoles", rateType: "Qty", basePrice: 650, imageUrl: U("photo-1690607953505-30e784f2b4cc"), size: "60 cm Ø × 110 cm", colours: ["Gold", "White"], materials: ["Steel", "Marble"], moods: ["Glam"], themes: ["Corporate", "Modern luxe"], setting: "Indoor & outdoor", fabrics: [], attributes: { "Seating capacity": "4 standing", "Frame material": "Steel" } },
  { id: "p27", name: "Gold Console Table", category: "Furniture", subcategory: "Tables and consoles", rateType: "Qty", basePrice: 7000, imageUrl: U("photo-1624304314520-8acb626f91f9"), size: "150 × 45 × 85 cm", colours: ["Gold", "White"], materials: ["Wood", "Marble"], moods: ["Regal"], themes: ["Royal heritage"], setting: "Indoor", fabrics: [], attributes: { "Seating capacity": "—", "Frame material": "Carved wood" } },
  { id: "p75", name: "Carved Puja Chowki", category: "Furniture", subcategory: "Tables and consoles", rateType: "Qty", basePrice: 1400, imageUrl: U("photo-1725822214190-8f4885126dee"), size: "90 × 60 × 45 cm", colours: ["Brown", "Gold"], materials: ["Sheesham wood", "Brass inlay"], moods: ["Traditional", "Festive"], themes: ["Festive & puja", "Royal heritage"], setting: "Indoor", fabrics: [], attributes: { "Seating capacity": "—", "Frame material": "Sheesham wood" } },
  { id: "p78", name: "Vintage Wooden Bar Counter", category: "Furniture", subcategory: "Tables and consoles", rateType: "Qty", basePrice: 8500, imageUrl: U("photo-1627594843456-d5db02355026"), size: "240 × 70 × 110 cm", colours: ["Brown"], materials: ["Reclaimed wood"], moods: ["Rustic", "Glam"], themes: ["Corporate", "Boho"], setting: "Indoor & outdoor", fabrics: [], attributes: { "Seating capacity": "6 standing", "Frame material": "Reclaimed wood" } },
  { id: "p28", name: "Velvet Pouf Set", category: "Furniture", subcategory: "Ottomans and poufs", rateType: "Qty", basePrice: 900, imageUrl: U("photo-1747204864511-4ec0d3350f19"), size: "Set of 4 · 45 cm Ø", colours: ["Blush", "Emerald"], materials: ["Upholstered"], moods: ["Boho", "Romantic"], themes: ["Haldi & mehendi", "Boho"], setting: "Indoor & outdoor", fabrics: ["Velvet", "Boucle", "Jute", "Cotton"], attributes: { "Seating capacity": "4", "Frame material": "Foam" } },

  // ───── Brass elements ─────
  { id: "p7", name: "Antique Brass Urn Planter", category: "Brass elements", subcategory: "Urns and vases", rateType: "Qty", basePrice: 450, imageUrl: U("photo-1763475944949-0715c3f8780f"), size: "35 cm Ø × 40 cm", colours: ["Brass"], materials: ["Brass"], moods: ["Traditional"], themes: ["Royal heritage", "Haldi & mehendi"], setting: "Indoor & outdoor", attributes: { Finish: "Antique", Height: "40 cm" } },
  ...
  { id: "p71", name: "Brass Samai Oil Lamp", category: "Brass elements", subcategory: "Candle stands", rateType: "Qty", basePrice: 950, imageUrl: U("photo-1757308530438-4e2340a6475f"), size: "30 cm Ø × 90 cm · 5 tiers", colours: ["Brass"], materials: ["Brass"], moods: ["Traditional", "Festive"], themes: ["Festive & puja"], setting: "Indoor", attributes: { Finish: "Polished", Height: "90 cm" } },
  ...
  { id: "p31", name: "Brass Jaali Screen", category: "Brass elements", subcategory: "Jaali screens", rateType: "Qty", basePrice: 4800, imageUrl: U("photo-1783456310361-ba537c7d7a66"), size: "120 × 200 cm", colours: ["Brass"], materials: ["Brass"], moods: ["Regal"], themes: ["Royal heritage"], setting: "Indoor", attributes: { Finish: "Antique", Height: "200 cm" } },
  { id: "p32", name: "Brass Elephant Sculpture", category: "Brass elements", subcategory: "Sculptural pieces", rateType: "Qty", basePrice: 3500, imageUrl: U("photo-1723749620166-f8de56d32d45"), size: "60 × 30 × 55 cm", colours: ["Brass"], materials: ["Brass"], moods: ["Traditional"], themes: ["Royal heritage"], setting: "Indoor", attributes: { Finish: "Polished", Height: "55 cm" } },
  { id: "p72", name: "Temple Bell Hangings", category: "Brass elements", subcategory: "Sculptural pieces", rateType: "Qty", basePrice: 1800, imageUrl: U("photo-1639028932959-156d7aee9dcc"), size: "Set of 12 · 90 cm drops", colours: ["Brass"], materials: ["Brass"], moods: ["Traditional", "Festive"], themes: ["Festive & puja", "Royal heritage"], setting: "Indoor & outdoor", attributes: { Finish: "Antique", Height: "90 cm" } },

  // ───── Flower props ─────
  { id: "p33", name: "Gold Pedestal Vase Stand", category: "Flower props", subcategory: "Vases and stands", rateType: "Qty", basePrice: 800, imageUrl: U("photo-1772093977510-a816ae50d491"), size: "30 cm Ø × 110 cm", colours: ["Gold"], materials: ["Metal"], moods: ["Romantic"], themes: ["Floral garden", "Modern luxe"], setting: "Indoor & outdoor", attributes: { "Real or faux": "Faux", "Flower type": "Roses", "Planter height": "110 cm" } },
  ...
  { id: "p35", name: "Marigold Garland Strings", category: "Flower props", subcategory: "Garlands and strings", rateType: "RFt", basePrice: 60, imageUrl: U("photo-1779518080209-8392ea286d06"), size: "Any length · 8 ft drops", colours: ["Yellow", "Orange"], materials: ["Marigold"], moods: ["Festive"], themes: ["Haldi & mehendi", "Festive & puja"], setting: "Indoor & outdoor", attributes: { "Real or faux": "Real", "Flower type": "Marigold", "Planter height": "—" } },
  ...
  { id: "p74", name: "Mango Leaf Bandhanwar", category: "Flower props", subcategory: "Garlands and strings", rateType: "RFt", basePrice: 45, size: "Any length", colours: ["Green"], materials: ["Mango leaves"], moods: ["Traditional"], themes: ["Festive & puja"], setting: "Indoor & outdoor", attributes: { "Real or faux": "Real", "Flower type": "Mango leaf", "Planter height": "—" } },
  { id: "p36", name: "Faux Peony Arrangement", category: "Flower props", subcategory: "Faux florals", rateType: "Qty", basePrice: 1100, imageUrl: U("photo-1575178094668-132dc931ad35"), size: "60 × 60 × 50 cm", colours: ["Pink", "Ivory"], materials: ["Silk florals"], moods: ["Romantic"], themes: ["Floral garden"], setting: "Indoor", attributes: { "Real or faux": "Faux", "Flower type": "Peony", "Planter height": "—" } },
  { id: "p77", name: "Dried Pampas Hoop", category: "Flower props", subcategory: "Faux florals", rateType: "Qty", basePrice: 1300, imageUrl: U("photo-1771400284343-9ed58477317f"), size: "120 cm Ø", colours: ["Beige", "Ivory"], materials: ["Dried pampas", "Metal hoop"], moods: ["Boho", "Minimal"], themes: ["Boho", "Beach"], setting: "Indoor & outdoor", attributes: { "Real or faux": "Real", "Flower type": "Pampas", "Planter height": "—" } },
  { id: "p13", name: "Floral Arch", category: "Flower props", subcategory: "Floral backdrops", rateType: "Qty", basePrice: 5500, imageUrl: U("photo-1641834919507-b0271fe5186b"), size: "250 × 60 × 280 cm", colours: ["Ivory", "Pink"], materials: ["Metal", "Faux florals"], moods: ["Romantic"], themes: ["Floral garden"], setting: "Indoor & outdoor", attributes: { "Real or faux": "Faux", "Flower type": "Mixed roses", "Planter height": "—" } },
  { id: "p65", name: "Marigold Wall Backdrop", category: "Flower props", subcategory: "Floral backdrops", rateType: "SqFt", basePrice: 85, size: "Up to 12 × 20 ft", colours: ["Yellow", "Orange"], materials: ["Marigold", "Net frame"], moods: ["Festive"], themes: ["Haldi & mehendi"], setting: "Indoor & outdoor", attributes: { "Real or faux": "Real", "Flower type": "Marigold", "Planter height": "—" } },
  { id: "p80", name: "Lotus Pond Installation", category: "Flower props", subcategory: "Floral backdrops", rateType: "Qty", basePrice: 7500, imageUrl: U("photo-1592195241273-5c30d3935d8c"), size: "240 × 120 cm water bed", colours: ["Pink", "White"], materials: ["Faux lotus", "Acrylic"], moods: ["Traditional", "Romantic"], themes: ["Festive & puja", "Floral garden"], setting: "Indoor & outdoor", attributes: { "Real or faux": "Faux", "Flower type": "Lotus", "Planter height": "—" } },

  // ───── Carpets and rugs ─────
  { id: "p9", name: "Persian Area Rug", category: "Carpets and rugs", subcategory: "Persian and traditional", rateType: "SqFt", basePrice: 25, imageUrl: U("photo-1660394585016-508f949df960"), size: "Up to 12 × 18 ft", colours: ["Red", "Blue"], materials: ["Wool blend"], moods: ["Traditional"], themes: ["Royal heritage"], setting: "Indoor", attributes: { Shape: "Rectangle", "Pile and finish": "Low pile", "Coverage available": "Up to 216 sq ft" } },
  { id: "p61", name: "Kilim Floor Rugs", category: "Carpets and rugs", subcategory: "Persian and traditional", rateType: "Qty", basePrice: 1200, imageUrl: U("photo-1717744258123-c3aceddf74d1"), size: "180 × 270 cm", colours: ["Red", "Multicolour"], materials: ["Handwoven wool"], moods: ["Boho", "Traditional"], themes: ["Boho", "Royal heritage"], setting: "Indoor & outdoor", attributes: { Shape: "Rectangle", "Pile and finish": "Flat weave", "Coverage available": "52 sq ft" } },
  { id: "p37", name: "Royal Printed Carpet", category: "Carpets and rugs", subcategory: "Printed", rateType: "Qty", basePrice: 2000, imageUrl: U("photo-1671576563965-23993d69eb17"), size: "300 × 200 cm", colours: ["Purple", "Gold"], materials: ["Polyester"], moods: ["Glam"], themes: ["Modern luxe"], setting: "Indoor", attributes: { Shape: "Rectangle", "Pile and finish": "Printed flat", "Coverage available": "65 sq ft" } },
  ...
  { id: "p8", name: "Red Carpet Runner", category: "Carpets and rugs", subcategory: "Aisle runners", rateType: "RFt", basePrice: 40, imageUrl: U("photo-1563884820531-2f8bc9e8889d"), size: "4 ft wide, any length", colours: ["Red"], materials: ["Needle-punch"], moods: ["Glam"], themes: ["Corporate", "Royal heritage"], setting: "Indoor & outdoor", attributes: { Shape: "Runner", "Pile and finish": "Flat", "Coverage available": "Up to 200 ft" } },
  { id: "p39", name: "Artificial Grass Turf", category: "Carpets and rugs", subcategory: "Outdoor and turf", rateType: "SqFt", basePrice: 18, imageUrl: U("photo-1780842815933-489d2e89d7a1"), size: "Rolls of 6 ft width", colours: ["Green"], materials: ["Polyethylene"], moods: ["Boho"], themes: ["Floral garden", "Beach"], setting: "Outdoor", attributes: { Shape: "Roll", "Pile and finish": "35 mm grass", "Coverage available": "Up to 5,000 sq ft" } },

  // ───── Small props ─────
  { id: "p40", name: "Gold Frame Mirror", category: "Small props", subcategory: "Mirrors", rateType: "Qty", basePrice: 1400, imageUrl: U("photo-1612392549429-a874f09c65f1"), size: "90 × 150 cm", colours: ["Gold"], materials: ["Glass", "Resin frame"], moods: ["Glam"], themes: ["Modern luxe", "Royal heritage"], setting: "Indoor", attributes: { Height: "150 cm", "Sold as set or single": "Single", "Frame finish": "Antique gold" } },
  { id: "p41", name: "Pillar Candle Set", category: "Small props", subcategory: "Candles and holders", rateType: "Qty", basePrice: 700, imageUrl: U("photo-1613068431228-8cb6a1e92573"), size: "Set of 12 · 10–30 cm", colours: ["Ivory"], materials: ["Wax", "Glass"], moods: ["Romantic"], themes: ["Floral garden", "Modern luxe"], setting: "Indoor", attributes: { Height: "10–30 cm", "Sold as set or single": "Set", "Frame finish": "—" } },
  { id: "p62", name: "Brass Diya Clusters", category: "Small props", subcategory: "Candles and holders", rateType: "Qty", basePrice: 600, imageUrl: U("photo-1636619773834-c7e0762ddfe1"), size: "Set of 24 · 8 cm Ø", colours: ["Brass", "Warm white"], materials: ["Brass", "Wax"], moods: ["Traditional", "Romantic"], themes: ["Festive & puja", "Royal heritage"], setting: "Indoor & outdoor", attributes: { Height: "6 cm", "Sold as set or single": "Set", "Frame finish": "Antique" } },
  ...
  { id: "p44", name: "Silk Cushion & Throw Set", category: "Small props", subcategory: "Cushions and throws", rateType: "Qty", basePrice: 500, imageUrl: U("photo-1553114552-c4ece3a33c93"), size: "Set of 6 · 45 × 45 cm", colours: ["Mustard", "Pink"], materials: ["Silk"], moods: ["Festive", "Boho"], themes: ["Haldi & mehendi", "Boho"], setting: "Indoor & outdoor", attributes: { Height: "45 cm", "Sold as set or single": "Set", "Frame finish": "—" } },

  // ───── Floor styling ─────
  { id: "p45", name: "LED Dance Floor", category: "Floor styling", subcategory: "Dance floors", rateType: "SqFt", basePrice: 90, imageUrl: U("photo-1708569177086-2710ef4b1620"), size: "2 × 2 ft panels", colours: ["White", "Multicolour"], materials: ["Acrylic", "LED"], moods: ["Glam", "Festive"], themes: ["Modern luxe", "Corporate"], setting: "Indoor & outdoor", attributes: { "Coverage sq ft": "Up to 576", "Load rating": "500 kg/m²", "Panel size": "2 × 2 ft" } },
  ...
  { id: "p48", name: "Carpeted Stage Steps", category: "Floor styling", subcategory: "Steps and risers", rateType: "Qty", basePrice: 1500, imageUrl: U("photo-1767294273267-0d4ef6712668"), size: "4 ft wide · 3 steps", colours: ["Red", "Black"], materials: ["Steel", "Carpet"], moods: ["Classic"], themes: ["Corporate", "Royal heritage"], setting: "Indoor & outdoor", attributes: { "Coverage sq ft": "12", "Load rating": "300 kg", "Panel size": "4 × 3 ft" } },

  // ───── Monumental installations ─────
  { id: "p49", name: "Carved Haveli Entry Gate", category: "Monumental installations", subcategory: "Entry gates and arches", rateType: "Qty", basePrice: 22000, imageUrl: U("photo-1524228529766-4d7fe5dc55ca"), size: "360 × 420 cm", colours: ["Ivory", "Gold"], materials: ["Fibreglass", "Wood"], moods: ["Regal"], themes: ["Royal heritage"], setting: "Indoor & outdoor", attributes: { "Height x width": "14 × 12 ft", "Freestanding or suspended": "Freestanding", "Install time": "6 hours" } },
  { id: "p6", name: "Round Mirror Backdrop", category: "Monumental installations", subcategory: "Backdrops and stage sets", rateType: "SqFt", basePrice: 450, imageUrl: U("photo-1724855946379-451f59d45df6"), size: "Up to 10 × 10 ft", colours: ["Silver"], materials: ["Mirror mosaic", "Metal"], moods: ["Glam"], themes: ["Modern luxe"], setting: "Indoor", attributes: { "Height x width": "10 × 10 ft", "Freestanding or suspended": "Freestanding", "Install time": "3 hours" } },
  { id: "p12", name: "Photo Booth Backdrop", category: "Monumental installations", subcategory: "Backdrops and stage sets", rateType: "Qty", basePrice: 2500, imageUrl: U("photo-1746587224861-521244472226"), size: "240 × 240 cm", colours: ["Multicolour"], materials: ["Printed panel"], moods: ["Festive"], themes: ["Corporate", "Haldi & mehendi"], setting: "Indoor & outdoor", attributes: { "Height x width": "8 × 8 ft", "Freestanding or suspended": "Freestanding", "Install time": "1 hour" } },
  { id: "p70", name: "Ganpati Makhar Backdrop", category: "Monumental installations", subcategory: "Backdrops and stage sets", rateType: "Qty", basePrice: 14500, imageUrl: U("photo-1598090216740-eb040d8c3f82"), size: "240 × 120 × 270 cm", colours: ["Gold", "Red", "Yellow"], materials: ["Eco board", "Fabric", "Faux florals"], moods: ["Festive", "Traditional"], themes: ["Festive & puja"], setting: "Indoor", attributes: { "Height x width": "9 × 8 ft", "Freestanding or suspended": "Freestanding", "Install time": "4 hours" } },
  ...
  { id: "p15", name: "Peak Pole Tent 40x60", category: "Monumental installations", subcategory: "Mandaps and canopies", rateType: "SqFt", basePrice: 18, imageUrl: U("photo-1768179123386-a86a85f1c35c"), size: "40 × 60 ft", colours: ["White"], materials: ["PVC", "Aluminium"], moods: ["Classic"], themes: ["Corporate", "Beach"], setting: "Outdoor", attributes: { "Height x width": "20 × 40 ft", "Freestanding or suspended": "Freestanding", "Install time": "1 day" } },
  { id: "p50", name: "Roman Pillars (Pair)", category: "Monumental installations", subcategory: "Pillars and columns", rateType: "Qty", basePrice: 4000, imageUrl: U("photo-1666681999714-3b3a28080a8b"), size: "45 cm Ø × 240 cm each", colours: ["White"], materials: ["Fibreglass"], moods: ["Classic", "Regal"], themes: ["Modern luxe", "Royal heritage"], setting: "Indoor & outdoor", attributes: { "Height x width": "8 × 1.5 ft", "Freestanding or suspended": "Freestanding", "Install time": "1 hour" } },
  { id: "p51", name: "Hanging Floral Ceiling", category: "Monumental installations", subcategory: "Ceiling installations", rateType: "SqFt", basePrice: 140, imageUrl: U("photo-1707432052387-b3d6f561429f"), size: "Custom area", colours: ["Ivory", "Green"], materials: ["Faux florals", "Truss"], moods: ["Romantic"], themes: ["Floral garden"], setting: "Indoor", attributes: { "Height x width": "Custom", "Freestanding or suspended": "Suspended", "Install time": "10 hours" } },
  { id: "p66", name: "Paper Umbrella Canopy", category: "Monumental installations", subcategory: "Ceiling installations", rateType: "SqFt", basePrice: 65, imageUrl: U("photo-1650370620007-cb1dd1a7684a"), size: "Custom area · 60 umbrellas per 400 sq ft", colours: ["Yellow", "Multicolour"], materials: ["Paper umbrellas", "Cable grid"], moods: ["Festive", "Boho"], themes: ["Haldi & mehendi", "Boho"], setting: "Indoor & outdoor", attributes: { "Height x width": "Custom", "Freestanding or suspended": "Suspended", "Install time": "5 hours" } },

  // ───── Lighting ─────
  { id: "p52", name: "Crystal Chandelier", category: "Lighting", subcategory: "Chandeliers", rateType: "Qty", basePrice: 5500, imageUrl: U("photo-1588436199489-ac376a0b3884"), size: "90 cm Ø × 110 cm", colours: ["Clear", "Gold"], materials: ["Crystal", "Metal"], moods: ["Regal", "Glam"], themes: ["Royal heritage", "Modern luxe"], setting: "Indoor", attributes: { "Mounting type": "Ceiling hung", "Power source": "Mains", "Colour temperature": "Warm white", Dimmable: "Yes" } },
  { id: "p53", name: "Moroccan Pendant Lanterns", category: "Lighting", subcategory: "Pendants and suspended", rateType: "Qty", basePrice: 900, imageUrl: U("photo-1605882090044-aa9cbe6df29e"), size: "Set of 3 · 30–60 cm", colours: ["Multicolour", "Brass"], materials: ["Metal", "Glass"], moods: ["Boho"], themes: ["Haldi & mehendi", "Boho"], setting: "Indoor & outdoor", attributes: { "Mounting type": "Suspended", "Power source": "Mains", "Colour temperature": "Warm white", Dimmable: "No" } },
  { id: "p82", name: "Hanging Lantern Canopy", category: "Lighting", subcategory: "Pendants and suspended", rateType: "SqFt", basePrice: 75, imageUrl: U("photo-1691927644490-e1a24b366a5e"), size: "Custom area · 1 lantern per 8 sq ft", colours: ["Warm white", "Brass"], materials: ["Paper", "Metal"], moods: ["Romantic", "Boho"], themes: ["Boho", "Floral garden"], setting: "Indoor & outdoor", attributes: { "Mounting type": "Suspended", "Power source": "Mains", "Colour temperature": "Warm white", Dimmable: "Yes" } },
  { id: "p54", name: "LED Uplighter", category: "Lighting", subcategory: "Uplighters and spots", rateType: "Qty", basePrice: 400, imageUrl: U("photo-1786237952245-cc8daea5288e"), size: "25 × 15 × 20 cm", colours: ["Black"], materials: ["Aluminium"], moods: ["Glam"], themes: ["Corporate", "Modern luxe"], setting: "Indoor & outdoor", attributes: { "Mounting type": "Floor", "Power source": "Battery", "Colour temperature": "RGB", Dimmable: "Yes" } },
  { id: "p10", name: "String Light Canopy", category: "Lighting", subcategory: "String and fairy lights", rateType: "RFt", basePrice: 60, imageUrl: U("photo-1780337675943-f63d92324e7b"), size: "Custom spans", colours: ["Warm white"], materials: ["Festoon bulbs"], moods: ["Romantic", "Boho"], themes: ["Floral garden", "Beach"], setting: "Outdoor", attributes: { "Mounting type": "Overhead strung", "Power source": "Mains", "Colour temperature": "Warm white", Dimmable: "Yes" } },
  { id: "p19", name: "Ambient Fairy Lighting", category: "Lighting", subcategory: "String and fairy lights", rateType: "RFt", basePrice: 55, imageUrl: U("photo-1551564874-2c247864797e"), size: "Any length", colours: ["Warm white"], materials: ["LED"], moods: ["Romantic"], themes: ["Floral garden", "Haldi & mehendi", "Festive & puja"], setting: "Indoor & outdoor", attributes: { "Mounting type": "Draped", "Power source": "Mains", "Colour temperature": "Warm white", Dimmable: "No" } },
  { id: "p55", name: "Gold Tripod Floor Lamp", category: "Lighting", subcategory: "Lamps and floor lighting", rateType: "Qty", basePrice: 1100, imageUrl: U("photo-1675767528117-963ce219b52a"), size: "60 cm Ø × 165 cm", colours: ["Gold", "Ivory"], materials: ["Metal", "Linen shade"], moods: ["Glam"], themes: ["Modern luxe"], setting: "Indoor", attributes: { "Mounting type": "Floor", "Power source": "Mains", "Colour temperature": "Warm white", Dimmable: "Yes" } },

  // ───── Fabric ─────
  { id: "p20", name: "Stage Draping", category: "Fabric", subcategory: "Drapes and curtains", rateType: "RFt", basePrice: 35, imageUrl: U("photo-1769107805446-a55542a7e75f"), size: "10 ft drop", colours: ["Ivory"], materials: ["Polyester"], moods: ["Classic"], themes: ["Royal heritage", "Corporate"], setting: "Indoor & outdoor", fabrics: ["Satin", "Chiffon"], attributes: { "Sheer or opaque": "Opaque", Width: "54 in", "Drop length": "10 ft" } },
  { id: "p56", name: "Ceiling Drape Swag", category: "Fabric", subcategory: "Ceiling drapes", rateType: "SqFt", basePrice: 45, imageUrl: U("photo-1653611600321-219adeb59a0f"), size: "Custom ceiling area", colours: ["White", "Blush"], materials: ["Polyester"], moods: ["Romantic"], themes: ["Floral garden", "Modern luxe"], setting: "Indoor", fabrics: ["Chiffon", "Organza", "Net"], attributes: { "Sheer or opaque": "Sheer", Width: "60 in", "Drop length": "Swagged" } },
  { id: "p84", name: "Bandhani Tent Ceiling", category: "Fabric", subcategory: "Ceiling drapes", rateType: "SqFt", basePrice: 55, size: "Custom ceiling area", colours: ["Red", "Yellow", "Multicolour"], materials: ["Cotton"], moods: ["Festive", "Traditional"], themes: ["Haldi & mehendi", "Royal heritage"], setting: "Indoor & outdoor", fabrics: ["Cotton", "Silk"], attributes: { "Sheer or opaque": "Opaque", Width: "44 in", "Drop length": "Pleated" } },
  { id: "p57", name: "Satin Table Linen", category: "Fabric", subcategory: "Table linen", rateType: "Qty", basePrice: 250, imageUrl: U("photo-1712764995305-75422fbe0ecc"), size: "Fits 60 in round table", colours: ["Ivory", "Gold", "Blush"], materials: ["Satin"], moods: ["Classic", "Glam"], themes: ["Corporate", "Modern luxe"], setting: "Indoor & outdoor", fabrics: ["Satin", "Tissue", "Sequin"], attributes: { "Sheer or opaque": "Opaque", Width: "120 in Ø", "Drop length": "Floor length" } },
  { id: "p58", name: "Chair Covers with Sashes", category: "Fabric", subcategory: "Chair covers and sashes", rateType: "Qty", basePrice: 90, imageUrl: U("photo-1524049446300-8de753838a96"), size: "Universal banquet fit", colours: ["White", "Gold"], materials: ["Spandex"], moods: ["Classic"], themes: ["Corporate", "Floral garden"], setting: "Indoor & outdoor", fabrics: ["Satin", "Organza", "Tissue"], attributes: { "Sheer or opaque": "Opaque", Width: "Standard", "Drop length": "Floor length" } },
  { id: "p59", name: "Sequin Backdrop Cloth", category: "Fabric", subcategory: "Backdrop cloth", rateType: "SqFt", basePrice: 55, imageUrl: U("photo-1634726605491-100b150374ec"), size: "Up to 12 × 20 ft", colours: ["Gold", "Rose gold"], materials: ["Sequin mesh"], moods: ["Glam", "Festive"], themes: ["Modern luxe", "Corporate"], setting: "Indoor", fabrics: ["Sequin", "Velvet", "Suede"], attributes: { "Sheer or opaque": "Opaque", Width: "58 in", "Drop length": "Up to 12 ft" } },
  { id: "p83", name: "Mirror-Work Backdrop Panels", category: "Fabric", subcategory: "Backdrop cloth", rateType: "SqFt", basePrice: 70, size: "Up to 10 × 16 ft", colours: ["Multicolour", "Silver"], materials: ["Cotton", "Mirror work"], moods: ["Festive", "Boho"], themes: ["Haldi & mehendi", "Boho"], setting: "Indoor & outdoor", fabrics: ["Cotton", "Silk"], attributes: { "Sheer or opaque": "Opaque", Width: "48 in", "Drop length": "Up to 10 ft" } },
];
